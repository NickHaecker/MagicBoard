...
<style scoped>
.erstereihe{display: flex; margin-top: 10%}
    .zweitereihe{display: flex; margin-top: 10%}
    .klas1{margin-left: 19%}
    .klas2{margin-left: 19%}
    .klassen{text-align: center;}
    .klassen p{margin-top: 22%;font-family: "Hind Vadodara";font-size: 35px;color: #FFFFFF}
    .schwierigkeitskarte{background: #4C7FCC}
</style>