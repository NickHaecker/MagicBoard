<template>
    <div>
        ...
        <section class="back">
            <router-link to="Startscreen" style="text-decoration: none;margin-left: 2%"><v-icon style="color: white; font-size: 70px; margin-bottom: 10%;background: #4C7FCC">mdi-arrow-left-drop-circle-outline</v-icon></router-link>
        </section>
    </div>
</template>
...
<style scoped>
.scoretable{margin-top: 5%;width: 70%;margin-left: 15%;background: #2D47AE;color: white;font-family: "Hind Vadodara"}
